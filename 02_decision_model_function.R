...
calculate_cea_output_private_AED <- function(l_list, n_wtp = 50000, return_all = FALSE, verbose = FALSE){
  with(as.list(l_list), {
    ...
    # Risk ratios are reported in the data, they can be applied to the probablities 
    ...
    # Calculate the rate of death after shockable cardiac arrest with AED use, based on heart rhythm (hr).
    ...
    #Probability of shockable rhythm by AED use
    ...
    v_CPC1_D <- c(p_CPC1_D_Y1 * p_multiplier, rep(p_CPC1_D * p_multiplier * hr_mortality, each = n_cycles - 1))
    
    v_CPC2_D <- c(p_CPC2_D_Y1 * p_multiplier, rep(p_CPC2_D * p_multiplier * hr_mortality, each = n_cycles - 1))
    
    v_CPC3_D <- c(p_CPC3_D_Y1 * p_multiplier, rep(p_CPC3_D * p_multiplier * hr_mortality, each = n_cycles - 1))
    
    v_CPC4_D <- c(p_CPC4_D_Y1 * p_multiplier, rep(p_CPC4_D * p_multiplier * hr_mortality, each = n_cycles - 1))
    
    
    # Initial distribution over the health states 
    v_m_init_AED <- c("CPC1"   = p_AED_used * p_shockable_AED * p_survive_shockable_AED * p_CPC1_shockable_AED/p_CPC_shockable_AED + 
                        #AED used, shockable, survive, CPC1
                        p_AED_used * p_nonshockable_AED * p_survive_nonshockable_AED * p_CPC1_nonshockable/p_CPC_nonshockable +
                        #AED used, nonshockable, survive, CPC1
                        p_AED_not_used * p_shockable_noAED * p_survive_shockable_noAED * p_CPC1_shockable_noAED/p_CPC_shockable_noAED +
                        #AED not used, shockable, survive, CPC1
                        p_AED_not_used * p_nonshockable_noAED * p_survive_nonshockable_noAED * p_CPC1_nonshockable/p_CPC_nonshockable,
                      #AED not used, non shockable, survive, CPC1            
                      "CPC2"   = p_AED_used * p_shockable_AED * p_survive_shockable_AED * p_CPC2_shockable_AED/p_CPC_shockable_AED + 
                        #AED used, shockable, survive, CPC2
                        p_AED_used * p_nonshockable_AED * p_survive_nonshockable_AED * p_CPC2_nonshockable/p_CPC_nonshockable +
                        #AED used, nonshockable, survive, CPC2
                        p_AED_not_used * p_shockable_noAED * p_survive_shockable_noAED * p_CPC2_shockable_noAED/p_CPC_shockable_noAED +
                        #AED not used, shockable, survive, CPC2
                        p_AED_not_used * p_nonshockable_noAED * p_survive_nonshockable_noAED * p_CPC2_nonshockable/p_CPC_nonshockable,
                      #AED not used, non shockable, survive, CPC2
                      "CPC3"   = p_AED_used * p_shockable_AED * p_survive_shockable_AED * p_CPC3_shockable_AED/p_CPC_shockable_AED + 
                        #AED used, shockable, survive, CPC3
                        p_AED_used * p_nonshockable_AED * p_survive_nonshockable_AED * p_CPC3_nonshockable/p_CPC_nonshockable +
                        #AED used, nonshockable, survive, CPC3
                        p_AED_not_used * p_shockable_noAED * p_survive_shockable_noAED * p_CPC3_shockable_noAED/p_CPC_shockable_noAED +
                        #AED not used, shockable, survive, CPC3
                        p_AED_not_used * p_nonshockable_noAED * p_survive_nonshockable_noAED * p_CPC3_nonshockable/p_CPC_nonshockable,
                      #AED not used, non shockable, survive, CPC3,  
                      "CPC4"   = p_AED_used * p_shockable_AED * p_survive_shockable_AED * p_CPC4_shockable_AED/p_CPC_shockable_AED + 
                        #AED used, shockable, survive, CPC4
                        p_AED_used * p_nonshockable_AED * p_survive_nonshockable_AED * p_CPC4_nonshockable/p_CPC_nonshockable +
                        #AED used, nonshockable, survive, CPC4
                        p_AED_not_used * p_shockable_noAED * p_survive_shockable_noAED * p_CPC4_shockable_noAED/p_CPC_shockable_noAED +
                        #AED not used, shockable, survive, CPC4
                        p_AED_not_used * p_nonshockable_noAED * p_survive_nonshockable_noAED * p_CPC4_nonshockable/p_CPC_nonshockable,
                      #AED not used, non shockable, survive, CPC4
                      "D"      = p_AED_used * p_shockable_AED * p_arrest_D_shockable_AED + 
                        #AED used, shockable, die
                        p_AED_used * p_nonshockable_AED * p_arrest_D_nonshockable_AED +
                        #AED used, nonshockable, die
                        p_AED_not_used * p_shockable_noAED * p_arrest_D_shockable_noAED +
                        #AED not used, shockable, die
                        p_AED_not_used * p_nonshockable_noAED * p_arrest_D_nonshockable_noAED)
    #AED not used, non shockable, die  
    
    v_m_init_noAED <- c("CPC1"   = p_shockable_noAED * p_survive_shockable_noAED * p_CPC1_shockable_noAED/p_CPC_shockable_noAED +
                          #shockable, survive, CPC1
                          p_nonshockable_noAED * p_survive_nonshockable_noAED * p_CPC1_nonshockable/p_CPC_nonshockable,
                        #non shockable, survive, CPC1            
                        "CPC2"   = p_shockable_noAED * p_survive_shockable_noAED * p_CPC2_shockable_noAED/p_CPC_shockable_noAED +
                          #shockable, survive, CPC2
                          p_nonshockable_noAED * p_survive_nonshockable_noAED * p_CPC2_nonshockable/p_CPC_nonshockable,
                        #non shockable, survive, CPC2
                        "CPC3"   = p_shockable_noAED * p_survive_shockable_noAED * p_CPC3_shockable_noAED/p_CPC_shockable_noAED +
                          #shockable, survive, CPC3
                          p_nonshockable_noAED * p_survive_nonshockable_noAED * p_CPC3_nonshockable/p_CPC_nonshockable,
                        #non shockable, survive, CPC3  
                        "CPC4"   = p_shockable_noAED * p_survive_shockable_noAED * p_CPC4_shockable_noAED/p_CPC_shockable_noAED +
                          #shockable, survive, CPC4
                          p_nonshockable_noAED * p_survive_nonshockable_noAED * p_CPC4_nonshockable/p_CPC_nonshockable,
                        #non shockable, survive, CPC4
                        "D"      = p_shockable_noAED * p_arrest_D_shockable_noAED +
                          #shockable, survive, CPC1
    ...
    wtp   <- 100000  # Willingness-to-pay-threshold of 100000
    ...
    for (t in 1:n_cycles){     # loop through the number of cycles
      ...
      m_M_AED[t + 1, ]   <- m_M_AED[t, ]  %*% a_P_AED[, , t]    # estimate the Markov trace
      # For the no AED strategy
      m_M_noAED[t + 1, ] <- m_M_noAED[t, ] %*% a_P_noAED[, , t]    # estimate the Markov trace, for the next cycle (t + 1)
    ...
    #AED Costs
    c_AED_CPC1_Y1 <-  c_AED_Arrest + (c_emergency_department + c_hospital_CPC1 + c_medical_CPC1) * c_multiplier
    c_AED_CPC2_Y1 <-  c_AED_Arrest + (c_emergency_department + c_hospital_CPC2 + c_medical_CPC2) * c_multiplier
    c_AED_CPC3_Y1 <-  c_AED_Arrest +  (c_emergency_department + c_hospital_CPC3 + c_medical_CPC3) * c_multiplier
    c_AED_CPC4_Y1 <-  c_AED_Arrest + (c_emergency_department + c_hospital_CPC4 + c_medical_CPC4) * c_multiplier
    ...
    c_noAED_D_Y1 <- (p_shockable_noAED * p_arrest_D_shockable_noAED * (c_emergency_department * c_multiplier * (p_die_emergency_department_shockable_noAED + p_die_hospital_shockable_noAED) + c_hospital_D * c_multiplier * p_die_hospital_shockable_noAED)) + (p_nonshockable_noAED * p_arrest_D_nonshockable_noAED * (c_emergency_department * c_multiplier * (p_die_emergency_department_nonshockable + p_die_hospital_nonshockable) + c_hospital_D * c_multiplier * p_die_hospital_nonshockable))
  ...
  df_ce_combined <- data.frame(Strategy = v_names_str,
                               Cost     = v_tc,
                               Effect   = v_tu,
                               ICER     = (v_tot_costs_AED - v_tot_costs_noAED)/(v_tot_qaly_AED - v_tot_qaly_noAED),
                               NMB      = v_nmb,
                               NHB      = v_nhb)
